...
function ProdutoList() {
    ...
    // parte 1 - copiar renderDesktopRow da página seguinte
    ...
    // parte 2 - copiar renderMobileCard da página seguinte
    ...
    // parte 3 - copiar return da página seguinte
    // parte 3 - Renderizar a tabela em desktop e os cards em mobile
    return (
        <PageLayout title="Produtos de Alisson" actions={actions}>
